...
//
// Bang kinh nghiem KHONG con o day nua. No da chuyen han sang CSDL —
// `profile.experience` — va sua truc tiep trong /admin/settings.
//
// Ly do ro rang: khi con la hang so trong file nay, chi mot lan deploy moi doi
// duoc mot chuc danh, nen no khong bao gio duoc doi. Luc doi chieu voi profile
// that thi bon tren nam vai tro deu sai. Du lieu ma chi mot nguoi sua duoc la
// du lieu khong ai sua.
//
