    ...
    <ToastContext.Provider value={{ toast }}>
      ...
      <div className="fixed bottom-4 right-4 z-50 flex flex-col gap-2">
        {toasts.map((t) => (
          <div
            key={t.id}
            className="relative overflow-hidden flex items-center gap-2.5 pl-3.5 pr-5 py-3 rounded-xl ring-1 ring-md-outline-variant bg-md-surface-container-high text-md-on-surface text-[15px] leading-[22px] animate-in slide-in-from-right fade-in-0 duration-200"
          >
            {t.type === "success" ? (
              <svg
                width="16"
